 ...
 * Class Menu
 * 
 * @author Chengzhuo Xiong created:09/29/2022 Modified: 11/09/2022
 */
public class Menu {
	private String name;
	...
	public double totalPrice() {
		double res = 0.0;
		double priEn = this.entree == null ? 0 : this.entree.getPrice();
		double priSide = this.side == null ? 0 : this.side.getPrice();
		double priSalad = this.salad == null ? 0 : this.salad.getPrice();
		double priDessert = this.dessert == null ? 0 : this.dessert.getPrice();
		res = priEn + priSide + priSalad + priDessert;
		return res;
	}
