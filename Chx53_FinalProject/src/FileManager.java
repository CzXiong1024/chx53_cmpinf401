...
public class FileManager {
	...
	/**
	 * Method readItems is capable to read the menu items from the file to the FileManager
	...
	/**
	 * Method writeMenu is able to write the menus in the arraylist to the destination file path
	 * @param fileName the destination of the filepath to which the process is going to write
	 * @param menus the menus inside the arraylist which is going to be written to the file
	 */
